...
const SalesReturnTab = () => {
  ...
  const TYPE = "Sales Return"; // preset type
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (!validItems.length)
        return message.error("Add at least one item before processing the return");
      ...
      <div style={{ display: "flex", gap: 20, padding: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          <Card title="Return Summary">
            ...
            <p>
              Discount %:{" "}
              <InputNumber min={0} max={100} value={discountPercent} onChange={setDiscountPercent} />
            </p>
            <p>
