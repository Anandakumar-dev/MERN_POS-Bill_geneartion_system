...
const PurchaseChallanTab = () => {
  ...
  const handleSubmit = async values => {
    try {
      ...
      message.success("Purchase Challan Created Successfully");
      ...
      message.error(err.response?.data?.message || "Failed to create purchase challan");
    }
  };
  ...
  return (
    <DefaultLayout>
      {/* Vendor dropdown + Date above table */}
      ...
      <div style={{ display: "flex", gap: 20, padding: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          <Card title="Challan Summary">
            ...
            <Button type="primary" onClick={handleSaveDraft} style={{ marginRight: 10 }}>Create Challan</Button>
...
export default PurchaseChallanTab;
